    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-12 self-start md:w-full md:max-w-48">
              ...
              <div className="flex-col">
                ...
                <small className="hidden md:block text-md md:pl-20 md:text-lg font-bold text-muted-foreground">
                  {item.subtitle}
                </small>
              </div>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <div className="flex-col">
                <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-primary leading-0">
                  {item.title}
                </h3>
                <small className="md:hidden block text-lg mb-4 text-left text-muted-foreground">
                  {item.subtitle}
                </small>
              </div>
